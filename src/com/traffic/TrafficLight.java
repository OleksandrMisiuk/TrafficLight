...
public class TrafficLight {
    ...
    ArrayList<Vehicle> north = new ArrayList<Vehicle>(10);
    ArrayList<Vehicle> east = new ArrayList<Vehicle>(10);
    ArrayList<Vehicle> south = new ArrayList<Vehicle>(10);
    ArrayList<Vehicle> west = new ArrayList<Vehicle>(10);
...
//        }
    ...
    private boolean noVehiclesLeft() {
        for(int i = 0; i < 5; i++) {
...
//    private boolean anyEmergency() {
//        return anyEmergency("n") || anyEmergency("s") || anyEmergency("w") || anyEmergency("e");
//    }
//
//    private boolean anyEmergency(String direction) {
//        switch(direction) {
//            case "n":
//                for(int i = 0; i < 5; i++) {
...
//    }
//
//    private int indexOfEmergency(ArrayList<Vehicle> list) {
//        for(int i = 0; i < 5; i++) {
